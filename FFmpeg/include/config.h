...
#define FFMPEG_CONFIGURATION "--prefix=/tmp/ffmpeg-build --enable-cross-compile --target-os=darwin --arch=aarch64 --sysroot=/Applications/Xcode_16.4.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS18.5.sdk --cc=/Applications/Xcode_16.4.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang --extra-cflags='-arch arm64 -isysroot /Applications/Xcode_16.4.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS18.5.sdk -miphoneos-version-min=13.0 -Oz -fembed-bitcode -DMOBILE_FFMPEG_LTS' --extra-ldflags='-arch arm64 -isysroot /Applications/Xcode_16.4.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS18.5.sdk -miphoneos-version-min=13.0' --enable-pic --enable-static --disable-shared --enable-small --disable-doc --disable-programs --disable-debug --disable-network --disable-autodetect --enable-videotoolbox --enable-audiotoolbox --disable-outdev=audiotoolbox --disable-openssl --disable-securetransport --disable-xlib --disable-sdl2 --disable-txtpages --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --enable-avfilter --enable-avdevice --enable-gpl --enable-postproc"
