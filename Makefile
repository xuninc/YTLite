...
$(TWEAK_NAME)_CFLAGS += -IFFmpeg/include -DMOBILE_FFMPEG_LTS -DMOBILE_FFMPEG_BUILD_DATE=20240101 -Wno-unused-but-set-variable
$(TWEAK_NAME)_CFLAGS += -Wno-duplicate-protocol -Wno-unguarded-availability-new -Wno-implicit-function-declaration -Wno-property-attribute-mismatch
